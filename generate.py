...
from rigify.utils.widgets import WGT_PREFIX, WGT_GROUP_PREFIX
from rigify.utils.widgets_special import create_root_widget
from rigify.utils.mechanism import refresh_all_drivers
from rigify.utils.misc import select_object, ArmatureObject, verify_armature_obj, choose_next_uid
from rigify.utils.collections import (ensure_collection, list_layer_collections,
                                filter_layer_collections_by_object)
from rigify.utils.rig import get_rigify_type, get_rigify_target_rig,\
...
from rigify.utils.objects import ArtifactManager
    ...
    def __rename_org_bones(self, obj: ArmatureObject):
        ...
        for i in range(0, len(original_bones)):
            ...
            if bone.name == ROOT_NAME:
                ...
                if get_rigify_type(bone) not in ('', 'WayRig.basic.raw_copy', 'basic.raw_copy'):
