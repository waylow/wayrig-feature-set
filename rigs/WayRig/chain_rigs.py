...
from rigify.utils.bones import put_bone, flip_bone, flip_bone_chain, is_same_position, is_connected_position
from rigify.utils.bones import copy_bone_position, connect_bbone_chain_handles
from rigify.utils.widgets_basic import create_bone_widget, create_sphere_widget
    ...
    def check_connect_tweak(self, org):
        ...
        if self.use_connect_chain and isinstance(self.rigify_parent, TweakChainRig):
            ...
            if not self.use_connect_reverse:
                ...
                name = self.rename_bone(name, strip_org(org) + '_tweak')
