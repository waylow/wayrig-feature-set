...
from rigify.utils.bones import align_bone_orientation, align_bone_to_axis, put_bone, set_bone_widget_transform
from ..widgets import create_torso_widget
...
class BaseSpineRig(TweakChainRig):
    ...
    def make_master_control_widget(self):
        ...
        create_torso_widget(self.obj, master, size=1.5)
    ...
    def rig_deform_bone(self, i, deform, tweak, next_tweak):
        ...
        if next_tweak:
            ...
            if self.params.make_preserve_volume:
                ...
                self.make_driver(con, 'bulge', variables=[(self.obj.pose.bones['Torso'], 'volume_preserve')])
