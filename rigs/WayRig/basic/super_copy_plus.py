...
class Rig(BaseRig, RelinkConstraintsMixin):
    ...
    def build_parent_switch(self):
        ...
        pbuilder.register_parent(self, self.bones.ctrl, name='Torso', tags={'torso', 'child'})

        pbuilder.build_child(
            self, self.bones.ctrl, exclude_self=True,
            extra_parents=parents, select_parent=org_parent,
            prop_id= self.bones.ctrl + '_parent', prop_name=self.bones.ctrl +' Parent',
