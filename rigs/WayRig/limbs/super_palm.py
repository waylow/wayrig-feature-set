...
def create_sample(obj):
    ...
    bone = arm.edit_bones.new('Palm_parent')
    bone.head[:] = 0.0000, 0.0000, 0.0000
    bone.tail[:] = 0.0577, 0.0000, -0.0000
    bone.roll = 3.1416
    bone.use_connect = False
    bones['Palm_parent'] = bone.name
    bone = arm.edit_bones.new('Palm_04')
    bone.head[:] = 0.0577, 0.0315, -0.0000
    bone.tail[:] = 0.1627, 0.0315, -0.0000
    bone.roll = 3.1416
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['Palm_parent']]
    bones['Palm_04'] = bone.name
    bone = arm.edit_bones.new('Palm_03')
    bone.head[:] = 0.0577, 0.0105, -0.0000
    bone.tail[:] = 0.1627, 0.0105, -0.0000
    bone.roll = 3.1416
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['Palm_parent']]
    bones['Palm_03'] = bone.name
    bone = arm.edit_bones.new('Palm_02')
    bone.head[:] = 0.0577, -0.0105, -0.0000
    bone.tail[:] = 0.1627, -0.0105, -0.0000
    bone.roll = 3.1416
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['Palm_parent']]
    bones['Palm_02'] = bone.name
    ...
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['Palm_parent']]
    bones['Palm_01'] = bone.name

    bpy.ops.object.mode_set(mode='OBJECT')
    pbone = obj.pose.bones[bones['Palm_parent']]
    pbone.rigify_type = ''
    ...
    pbone = obj.pose.bones[bones['Palm_04']]
    pbone.rigify_type = ''
    pbone.lock_location = (False, False, False)
    ...
    pbone = obj.pose.bones[bones['Palm_03']]
    pbone.rigify_type = ''
    pbone.lock_location = (False, False, False)
    pbone.lock_rotation = (False, True, True)
    pbone.lock_rotation_w = False
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'YXZ'
    pbone = obj.pose.bones[bones['Palm_02']]
    pbone.rigify_type = ''
    pbone.lock_location = (False, False, False)
    pbone.lock_rotation = (False, True, True)
    pbone.lock_rotation_w = False
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'YXZ'
    pbone = obj.pose.bones[bones['Palm_01']]
