...
from rigify.utils.bones import put_bone, flip_bone, align_chain_x_axis, set_bone_widget_transform, align_bone_y_axis
...
class Rig(SimpleChainRig):
    ...
    def make_tip_control_bone(self, org, name_org):
        name = self.copy_bone(org, make_derived_name(name_org, 'ctrl', '_tip'), parent=False)
    ...
    def add_parameters(self, params):
        ...
        params.align_control_to_tip = bpy.props.BoolProperty(
            name        = 'Align Master Control to Tip',
            default     = True,
            description = "Align the master finger control to the tip of the finger and not the first segment",
        )
    ...
    def parameters_ui(self, layout, params):
        ...
        r = layout.row()
        r.prop(params, "align_control_to_tip", text="Align control to tip")
